...
PartyService.Start()
print("RunMatchService: PartyService started")
local LobbyService=require(servicesFolder:WaitForChild("LobbyService"))
LobbyService.Start()
print("RunMatchService: LobbyService started")
...
local QualificationZoneService=require(servicesFolder:WaitForChild("QualificationZoneService"))
QualificationZoneService.Start()
print("RunMatchService: QualificationZoneService started")
